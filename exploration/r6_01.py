...
for fill in ["finite_min", "finite_max", 20.0, 40.0]:
    R(f"Mask(fill={fill}) FSO u1 + lzma delta1 lc4 pb0", lambda fill=fill: mask([fso(), lz(1, 4, 0, 0)], fill))
json.dump(log, open("log_r6_01.json", "w"), indent=1)
print("DONE r6_01")
